# klogs.sh - Kubernetes pod log and container info functions for shell
# Source this file from your .aliases or shell config.
# Requires: kubectl, jq, column
# Usage: klogs [flags] [app-name]
# Functions: klogs, klogs_container_info
